...
SECRET_KEY = "django-insecure-z!s2$g(##y0s_8xnrxi=be8nhx(xly!0j^nc1*)_rtxfg%qx77"
...
EMAIL_HOST_USER = "aasmolnikov@gmail.com"
...
AUTHENTICATION_BACKENDS = [
    ...
    "django.contrib.auth.backends.ModelBackend",  # Для стандартной авторизации
]
